...
\startitemize[joinedup,columns,two]
  \item Clojure, ClojureScript, Babashka & Cherry.
...
\Position{Sabatical}{lonely soldier}{March 2021 -- July 2024}
\startitemize
  ...
  \item Studied Traditional Chinese Medicine (TCM) and Ayurveda to improve diet and overall health.
  \item The free time allowed me to discover and learn Clojure, which reignited my passion for software development.
  \item Camino de Santiago de Compostela.
\stopitemize
...
\Position{Blogger}{\from[homepage]}{2000~-- Present}
