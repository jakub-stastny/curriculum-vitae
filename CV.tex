...
\setupnotation[footnote][location=text,way=bysection]
...
\setupurl[color=black,style=\tt]

% For \goto and \from:
\setupinteraction[state=start,color=darktitle] % ,style=\tt
...
\Position{Root.cz}{Technical redactor}{December 2006~-- August 2008}
\startitemize
  ...
  \item {\bf My articles:} \from[root-profile].
\stopitemize

%% I was 20 yo when I moved to London.
\useURL[jgp][https://www.jobsgopublic.com]
\Position{JobsGoPublic.co.uk}{Junior Ruby & JavaScript developer}{May 2009~--XXX 2010}
\startitemize
\stopitemize

\useURL[dachis-acquisition][https://www.venturecapitaljournal.com/dachis-group-buys-headshift]
\Position{Headshift Ltd}{Junior Ruby & JavaScript developer}{May 2009~--XXX 2010}
{\em Headshift Ltd was \color[blue]{\goto{acquired by the Dachis group}[url(https://www.venturecapitaljournal.com/dachis-group-buys-headshift)]}.}
{\em Headshift Ltd was acquired by the Dachis group\footnote{
\from[dachis-acquisition]
}.}

This rocks\footnote{and sucks at the same time}.
...
\page[yes] % Forces a new page for the footnotes
